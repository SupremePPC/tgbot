...
return [
    ...
    */
    'commands' => [
        //Acme\Project\Commands\MyTelegramBot\BotCommand::class,
        App\Telegram\Commands\StartCommand::class, // this is your StartCommand
    ],
    ...
    */
    'shared_commands' => [
        ...
        'start' => App\Telegram\Commands\StartCommand::class, // this is your StartCommand
    ],
